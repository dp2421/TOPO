...
m_fMaxLifeTime(0.5f),m_fMinSpeed(10),m_fMaxSpeed(20.f),m_fStartScale(10.f),m_fEndScale(20.f),m_vStartColor(Vec4(1.0f,0.4f,0.8f,1.4f)),m_vEndColor(Vec4(1.f,1.f,1.f,1.0f))
{
